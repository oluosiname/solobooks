...
ActiveRecord::Schema[7.1].define(version: 2024_10_26_200208) do
  ...
  create_table "financial_categories", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["name", "category_type"], name: "index_financial_categories_on_name_and_category_type", unique: true
  end
